...
Scalar<DataVector> speed_with_index_mesh_velocity(
  ...
  return Scalar<DataVector>{SoScalarWave::characteristic_speeds<Dim>(
...
void test_characteristic_speeds_nullopt_matches() {
  ...
  const auto speeds_no_arg = SoScalarWave::characteristic_speeds(normal);
  const auto speeds_nullopt = SoScalarWave::characteristic_speeds(
      normal,
...
typename Tag::type field_with_tag(
  ...
  Variables<tmpl::list<SoScalarWave::Tags::VPsi, SoScalarWave::Tags::VZero<Dim>,
...
void test_evolved_from_characteristic_fields() {
  ...
  // Phi
  pypp::check_with_random_values<1>(
      evol_field_with_tag<SoScalarWave::Tags::Phi<Dim>, Dim>, "Characteristics",
...
void test_evolved_from_characteristic_fields_analytic(
  ...
  {
    const auto fields = SoScalarWave::evolved_fields_from_characteristic_fields(
