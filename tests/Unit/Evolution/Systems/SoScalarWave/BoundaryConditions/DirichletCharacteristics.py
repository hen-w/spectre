...
def _pick(
    speed, interior_val, analytic_val, prescribe_zero, zero_incoming=False
):
...
def _compute_ghost(
    ...
    # Mode selection
    vpsi_ext = _pick(
        speed_vpsi, vpsi_int, vpsi_an, prescribe_zero, zero_incoming
    )
    vplus_ext = _pick(
        speed_vplus, vplus_int, vplus_an, prescribe_zero, zero_incoming
    )
    vminus_ext = _pick(
        speed_vminus, vminus_int, vminus_an, prescribe_zero, zero_incoming
    )
    vzero_ext = _pick(
        speed_vzero, vzero_int, vzero_an, prescribe_zero, zero_incoming
    )
