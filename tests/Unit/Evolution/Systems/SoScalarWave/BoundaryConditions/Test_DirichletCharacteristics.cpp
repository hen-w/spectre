...
void test_prescribe_zero() {
  ...
  helpers::test_boundary_condition_with_python<
      ...
      tuples::TaggedTuple<
          ...
          helpers::Tags::PythonFunctionName<::Tags::dt<SoScalarWave::Tags::Pi>>,
          helpers::Tags::PythonFunctionName<
              ::Tags::dt<SoScalarWave::Tags::Phi<Dim>>>,
          helpers::Tags::PythonFunctionName<
              ::Tags::dt<SoScalarWave::Tags::BoundaryPsi>>>{
          "error", "psi_prescribe_zero", "pi_prescribe_zero",
          "phi_prescribe_zero", "boundary_psi_prescribe_zero",
          "dt_psi_prescribe_zero", "dt_pi_prescribe_zero",
...
void test_keep_zero() {
  ...
  helpers::test_boundary_condition_with_python<
      ...
      tuples::TaggedTuple<
          ...
          "boundary_psi_keep_zero", "dt_psi_keep_zero", "dt_pi_keep_zero",
...
void test_copy_psi() {
  ...
  helpers::test_boundary_condition_with_python<
      ...
      tuples::TaggedTuple<
          ...
          helpers::Tags::PythonFunctionName<
              ::Tags::dt<SoScalarWave::Tags::BoundaryPsi>>>{
          "error", "psi_copy_interior", "pi_copy_interior", "phi_copy_interior",
          "boundary_psi_copy_interior", "dt_psi_copy_interior",
          "dt_pi_copy_interior", "dt_phi_copy_interior",
          "dt_boundary_psi_copy_interior"},
      yaml_string<Dim>() +
          "  PrescribeZeroSpeedModes: false\n"
...
void test_zero_incoming() {
  ...
  helpers::test_boundary_condition_with_python<
      ...
      tuples::TaggedTuple<
          ...
          helpers::Tags::PythonFunctionName<
              ::Tags::dt<SoScalarWave::Tags::BoundaryPsi>>>{
          "error", "psi_zero_incoming", "pi_zero_incoming", "phi_zero_incoming",
          "boundary_psi_zero_incoming", "dt_psi_zero_incoming",
          "dt_pi_zero_incoming", "dt_phi_zero_incoming",
          "dt_boundary_psi_zero_incoming"},
      yaml_string<Dim>() +
          "  PrescribeZeroSpeedModes: false\n"
          "  CopyPsiFromInterior: false\n"
