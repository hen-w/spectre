...
void test_constraint_characteristics(
  ...
  const auto char_fields = ::Ccz4::fd::characteristic_fields(
      unit_normal_one_form,
      get<::Ccz4::Tags::ConformalMetric<DataVector,
                                        ::Ccz4::fd::System::volume_dim>>(
          volume_evolved_vars),
      get<::Ccz4::Tags::ConformalFactor<DataVector>>(volume_evolved_vars),
      get<gr::Tags::Lapse<DataVector>>(volume_evolved_vars),
      get<gr::Tags::Shift<DataVector, ::Ccz4::fd::System::volume_dim,
      ...
      get<::Ccz4::Tags::GammaHat<DataVector, ::Ccz4::fd::System::volume_dim>>(
          volume_evolved_vars),
      get<::Ccz4::Tags::AuxiliaryShiftB<DataVector,
                                        ::Ccz4::fd::System::volume_dim>>(
          volume_evolved_vars),
      get<Tags::deriv<
      ...
      get<Tags::deriv<gr::Tags::Lapse<DataVector>,
                      ...
                      Frame::Inertial>>(deriv_of_Ccz4_vars),
      get<Tags::deriv<
          gr::Tags::Shift<DataVector, ::Ccz4::fd::System::volume_dim,
                          Frame::Inertial>,
          tmpl::size_t<::Ccz4::fd::System::volume_dim>, Frame::Inertial>>(
          deriv_of_Ccz4_vars),
      ::Ccz4::fd::System::f);
  ...
  ::Ccz4::fd::ConstraintCharacteristicFieldsCompute<Frame::Inertial>::function(
      ...
      get<Tags::deriv<
          ...
          tmpl::size_t<::Ccz4::fd::System::volume_dim>, Frame::Inertial>>(
          deriv_of_Ccz4_vars),
      get<::Ccz4::fd::Tags::UVector2Plus<
          DataVector, ::Ccz4::fd::System::volume_dim, Frame::Inertial>>(
          char_fields),
      get<::Ccz4::fd::Tags::UVector2Minus<
          DataVector, ::Ccz4::fd::System::volume_dim, Frame::Inertial>>(
          char_fields),
