...
class LaxFriedrichs final : public evolution::BoundaryCorrection {
 public:
   ...
   * (`System::variables_tag`, i.e. `Psi, Pi`) followed by the auxiliary
   * variables (`System::auxiliary_variables`, i.e. `Phi`). This matches the
   * framework's projection list
   ...
   * (`System::variables_tag`, i.e. `Psi, Pi`) to the face - the auxiliary
   * variables (`Phi`) are being computed by this pass and are not read here.
   * The projected inputs are therefore passed positionally in `variables_tag`
   * order.
   */
