...
class DirichletAnalytic final : public BoundaryCondition<Dim> {
 public:
  ...
  static constexpr Options::String help{
      "DirichletAnalytic boundary conditions setting the value of Psi and"
      " Pi to the analytic solution or analytic data."};
  ...
  // provides them: the evolved variables (Psi, Pi) followed by the auxiliary
  // variables (Phi). This matches the framework's ghost-fill order
