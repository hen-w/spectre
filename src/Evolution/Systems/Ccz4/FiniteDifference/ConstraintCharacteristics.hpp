...
struct ConstraintCharacteristicFieldsCompute
  ...
  using return_type = typename base::type;
  using argument_tags =
      tmpl::list<::Ccz4::Tags::Theta<DataVector>,
                 ::Ccz4::Tags::SpatialZ4ConstraintUp<
                     DataVector, ::Ccz4::fd::System::volume_dim, Frame>,
                 gr::Tags::SpatialMetric<DataVector,
                                         ::Ccz4::fd::System::volume_dim, Frame>,
                 ::Tags::Normalized<domain::Tags::UnnormalizedFaceNormal<
                     ::Ccz4::fd::System::volume_dim, Frame>>>;
  static void function(
      const gsl::not_null<return_type*> result, const Scalar<DataVector>& theta,
      const tnsr::I<DataVector, ::Ccz4::fd::System::volume_dim, Frame>&
          upper_spatial_z4_constraint,
      const tnsr::ii<DataVector, ::Ccz4::fd::System::volume_dim, Frame>&
          spatial_metric,
      const tnsr::i<DataVector, ::Ccz4::fd::System::volume_dim, Frame>&
          unit_normal_one_form) {
    constraint_characteristic_fields(result, theta, upper_spatial_z4_constraint,
