...
struct SoTimeDerivative {
  ...
  static void apply(const gsl::not_null<db::DataBox<DbTagsList>*> box) {
    ...
    // Handling ConstraintRadiationPreserving BCs
    else if (dynamic_cast<const Ccz4::BoundaryConditions::
      ...
      db::mutate<dt_variables_tag>(
          [&](const auto dt_vars_ptr, const auto& inertial_coords,
            ...
            tmpl::for_each<
                Ccz4::fd::System::variables_tag_list>([&]<typename Tag>(
                                                          tmpl::type_<
                                                              Tag> /*meta*/) {
              const auto& var = get<Tag>(evolved_vars);
            ...
            // fields.
            /* Probably should write a separate functions for dt of
             characteristic fields and evolved fields as reusing tags is prone
             to mistake */
